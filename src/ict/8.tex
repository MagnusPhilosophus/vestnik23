...
{\bfseries A COMPREHENSIVE APPROACH TO ENHANCING THE RESILIENCE OF}

{\bfseries INFORMATION SYSTEMS: FROM MATHEMATICAL MODELING TO RISK
...
{\bfseries АҚПАРАТТЫҚ ЖҮЙЕЛЕРДІҢ ТҰРАҚТЫЛЫҒЫН АРТТЫРУДЫҢ КЕШЕНДІ ТӘСІЛІ:
МАТЕМАТИКАЛЫҚ МОДЕЛЬДЕУДЕН ТӘУЕКЕЛДЕРДІ БАСҚАРУ}

{\bfseries СТРАТЕГИЯСЫНА ДЕЙІН}
...
{\bfseries КОМПЛЕКСНЫЙ ПОДХОД К ПОВЫШЕНИЮ УСТОЙЧИВОСТИ ИНФОРМАЦИОННЫХ
...
{\bfseries Table 1 - Important components of Information systems (IS)}
...
{\bfseries Figure 1 - Characteristics of the functioning of the IS}
...
{\bfseries Figure 2 - Errors that can lead to failures And}
...
{\bfseries Figure 3- Information systems}
...
{\bfseries Figure 4 - Schematic representation of the hierarchy of failure
states of an information system with}

{\bfseries modeling based on Markov chains}
