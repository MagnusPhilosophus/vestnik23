...
{\bfseries TARGET IDENTIFICATION AND TRACKING IN COMPLEX ENVIRONMENT}
...
{\bfseries КҮРДЕЛІ ОРТАДА НЫСАНАНЫ АНЫҚТАУ ЖӘНЕ БАҚЫЛАУ}
...
{\bfseries ИДЕНТИФИКАЦИЯ И ОТСЛЕЖИВАНИЕ ЦЕЛЕЙ В СЛОЖНЫХ УСЛОВИЯХ}
...
{\bfseries Figure 1- Drone in battlefield. a) Drone take off for
...
{\bfseries Figure 2- Schematic diagram of drone operation}
...
{\bfseries Figure 4 - Flowchart of Machine Learning Process for Object
