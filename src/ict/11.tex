...
{\bfseries STUDY OF THE REPRESENTATIVENESS OF KAZAKH LANGUAGE CORPORA BY
...
{\bfseries ЖИНАҚТАУ ТАПСЫРМАСЫ БОЙЫНША ҚАЗАҚ ТІЛІ КОРПУСЫНЫҢ СӨЗ}
...
{\bfseries ИССЛЕДОВАНИЕ РЕПРЕЗЕНТАТИВНОСТИ КОРПУСОВ КАЗАХСКОГО ЯЗЫКА}

{\bfseries ПО СТЕМАМ СЛОВ ДЛЯ ЗАДАЧИ СУММАРИЗАЦИИ}
...
{\bfseries Figure 1- Algorithm of representativeness analyze}
...
{\bfseries Table 1 - Train datasets statistics}
...
\bottomrule\noalign{}
\endlastfoot
{\bfseries train dataset} & {\bfseries stems} & {\bfseries strings} \\
...
{\bfseries Table2 - Summary statistics for test files}
...
\bottomrule\noalign{}
\endlastfoot
{\bfseries test file} & {\bfseries stems} \\
test text 1 & 168 \\
test text 2 & 386 \\
test text 3 & 86 \\
\end{longtable}
...
{\bfseries Table 3 - BLEU scores and sample sizes by model}
...
\bottomrule\noalign{}
\endlastfoot
\multirow{2}{*}{{\bfseries test source file}} & \multicolumn{2}{l}{%
{\bfseries Medium model}} & \multicolumn{2}{l}{%
{\bfseries Full model stems}} & \multicolumn{2}{l@{}}{%
{\bfseries Short model}} \\
& {\bfseries Stems} & {\bfseries BLUE} & {\bfseries stems} & {\bfseries BLUE} &
{\bfseries stems} & {\bfseries BLUE} \\
...
{\bfseries Figure 2 - Resulting scores with the number of stems in test
files}
...
{\bfseries Table 4 - Example of the received text on test file}
...
\bottomrule\noalign{}
\endlastfoot
{\bfseries Оriginal sentence} & {\bfseries Medium model} & {\bfseries Short
model} & {\bfseries Full model} \\
