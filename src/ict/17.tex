...
\sectionwithauthors{A.M. Jumagaliyeva, A.D. Tulegulov, G.E. Murzabekova, G.K. Muratova}{APPLICATION OF SMART CONTRACTS IN ELECTRONIC SYSTEMS BASED ON
...
\begin{table}[H]
\caption*{Table1- Advantages and Disadvantages of Blockchain-Based Smart Contracts}
\centering
\resizebox{\textwidth}{!}{%
\begin{tabular}{|l|l|}
\hline
Advantages                                   & Disadvantages                                             \\ \hline
Transparency and trust through visibility    & Technical complexity and coding errors                    \\ \hline
Enhanced security with encryption            & Scalability issues with transaction times/costs           \\ \hline
Increased efficiency and speed               & Legal and regulatory uncertainties                        \\ \hline
Cost reduction by eliminating intermediaries & Interoperability challenges between platforms             \\ \hline
Reduction in human errors                    & Limited to predefined code logic                          \\ \hline
Trustless execution promoting autonomy       & Difficult to modify once deployed                         \\ \hline
Promotes innovation in contract execution    & Potential for unexpected outcomes due to rigid code       \\ \hline
Automatic compliance with contract terms     & Energy consumption concerns for proof-of-work blockchains \\ \hline
Immediate transaction settlement             & Lack of understanding and trust from the public           \\ \hline
\end{tabular}%
}
\end{table}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{assets/78}
	\caption*{Fig.1- Deployment of blockchain}
\end{figure}
