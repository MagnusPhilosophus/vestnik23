...
{\bfseries АНАЛИЗ РАСШИРЕННЫХ ВОЗМОЖНОСТЕЙ СИСТЕМЫ SIEM ЧЕРЕЗ ИНТЕГРАЦИЮ С
IBM QRADAR}
...
{\bfseries \textsuperscript{3}А.К. Адильбекова, \textsuperscript{1}С.М.
Жаксыбай}
...
{\bfseries IBM QRADAR ИНТЕГРАЦИЯСЫ АРҚЫЛЫ SIEM ЖҮЙЕСІНІҢ КЕҢЕЙТІЛГЕН
...
{\bfseries ANALYZE SIEM SYSTEM ADVANCED FEATURES THROUGH INTEGRATION WITH
IBM QRADAR}
...
{\bfseries \textsuperscript{3}A.K. Adilbekova, \textsuperscript{1}S.M.
Zhaksybay}
...
{\bfseries Рис. 1 -- Импорт необходимых библиотек}
...
{\bfseries Рис. 2 -- Flask-приложение}
...
{\bfseries Рис. 3 - Анализ сетевого трафика}
...
{\bfseries Рис. 4 - Функция обнаружения аномального трафика}
...
{\bfseries Рис. 5 - Цветовая индикация угроз}
...
{\bfseries Рис. 6 - Исходящий трафик Рис. 7 - Входящий трафик}
