...
{\bfseries THE USE OF DIGITAL TECHNOLOGIES FOR INTELLIGENT TRAFFIC MANAGEMENT}
...
{\bfseries КӨЛІК АҒЫНДАРЫН ИНТЕЛЛЕКТУАЛДЫ БАСҚАРУ ҮШІН ЦИФРЛЫҚ
...
{\bfseries ПРИМЕНЕНИЕ ЦИФРОВЫХ ТЕХНОЛОГИЙ ДЛЯ ИНТЕЛЛЕКТУАЛЬНОГО УПРАВЛЕНИЯ
...
{\bfseries Introduction}\emph{.} The global experience in the development
...
{\bfseries Figure 1 - Forecast for 2024 of the processes of development of
congestion on the central roads in}

{\bfseries the city of Almaty (overview of the current situation of
congestion in Almaty according}

{\bfseries to the data yandex.kz )}
...
{\bfseries Figure 2 - Graph of traffic flow during rush hour from east to
west in Almaty along Abai,}

{\bfseries Satpayev and Shevchenko streets}
...
{\bfseries Figure 3 - Calculation results based on a simulation model for
...
{\bfseries Figure 4 - Electrical diagram of the smart interface for
